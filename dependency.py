...
def setup_environment(ForceUpdateDependencies, ForceTemporaryStorage):
    ...
    if ForceTemporaryStorage:
        ...
        file_path = '/kaggle/working/drive/MyDrive/RVC_Cached/CachedRVC.tar.gz'
    ...
    if Path(file_path).exists():
        ...
        os.makedirs('/kaggle/working/drive/MyDrive/RVC_Cached', exist_ok=True)
        shutil.copy('/kaggle/working/CachedRVC.tar.gz', '/kaggle/working/drive/MyDrive/RVC_Cached/CachedRVC.tar.gz')
